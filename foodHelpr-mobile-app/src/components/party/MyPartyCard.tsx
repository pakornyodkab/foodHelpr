  ...
  return (
    <View className="mb-4 flex max-w-sm space-y-1 rounded-lg border-2 border-green-500 bg-transparent p-4 shadow-lg ">
      ...
      <View className="flex-row items-center space-x-2">
        ...
        <Text className="font-medium text-green-500">McDonald Paragon</Text>
      </View>
      ...
      <View className="flex-row items-center justify-between">
        ...
        <View className="flex-row">
          <Button className="rounded-lg bg-green-500 px-2 py-1 shadow-md duration-150 hover:shadow-lg focus:shadow-lg active:scale-95 active:bg-green-700 active:shadow-lg" onPress={() => handleChatPress()}>
